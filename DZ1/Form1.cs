...
namespace DZ1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Search(DataGridView dgw)
        {
            ...
            string searchString = $"select * from contact where concat (name, phone) like '%" + textBox1.Text + "%'";
        ...
        private void Update ()
        {
            ...
            for (int index = 0; index < dataGridView1.Rows.Count; index++)
            {
                ...
                if (rowState == RowState.Modifided)
                {
                    ...
                    var changeQuery = $"update contact set name = '{name}', phone = '{phone}' where id = '{id}'";
